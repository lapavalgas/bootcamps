...
export default function Routes() {
    return (
        /**
         * A propriedade ``` screenOptions={{ headerShown: false}} ``` tem por propósito desabilitar os headers da navegação em modelo stack
         * cardStyle é para criação de headers customizados
         */
        <NavigationContainer>
